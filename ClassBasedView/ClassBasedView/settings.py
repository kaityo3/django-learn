...
SECRET_KEY = "django-insecure-g+#n)(i!!ja$wrs9)#b=o3)ynkx6ee$t#^q$#1onilpp#6ig9g"
...
# 上から順に実行され、下から順に返す
MIDDLEWARE = [
    # 最初にPerformanceの処理を実施して、最後にresponceが返った時間を測る
...
LOGGING = {
    ...
    "handlers":{
        ...
        "timed_file_handler":{
            ...
            "formatter": "simple",
            "encoding": "utf-8",
            # 書き込みとローテーションが重なるとエラーになってしまう事象を避ける効果あり
            "delay": True,
        },
        "timed_error_handler":{
            "level": "ERROR",
