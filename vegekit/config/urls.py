...
# logoutviewはlogoutのpathに進んだ段階でlogoutできるようにすればいい
# つまり機能追加が必要無いためViewsフォルダで定義せず、簡単に書く
...
urlpatterns = [
    ...
    path('passwdChg/', views.PasswordChange.as_view()),

    # Order
    # order.htmlの内容をorders/str:pkのurlで表示する
